...
async def process_tool_call(tool_call: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Args:
        tool_call: The tool call data from OpenAI
...
async def proxy_chat_completion(request: Request, data: Any) -> Response:
    ...
    Before sending to OpenAI, performs vector search for retrieval augmented generation.
        ...
        async with httpx.AsyncClient() as client:
            ...
            if "choices" in response_data and len(response_data["choices"]) > 0:
                ...
                if "message" in choice and "tool_calls" in choice["message"]:
                    ...
                    # Create new request to send back to OpenAI
...
async def handle_streaming_response(client, target_url, headers, json_data):
    """
    Handle streaming responses from OpenAI with tool call support.
    """
